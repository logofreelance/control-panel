...
import { Button, Input, Badge, Card, CardContent, Modal, Select } from '@/components/ui';
...
export const ApiKeysAndCorsView = ({ targetId }: ApiKeysAndCorsViewProps) => {
  ...
  return (
    <TargetLayout>
      <div className="relative z-10 space-y-6 animate-page-enter">
            ...
            <Card className="max-w-md w-full animate-in zoom-in-95 duration-200">
              <CardContent>
                ...
                <div className="bg-muted rounded-xl p-5 mb-6 select-all">
                  <p className="text-base text-foreground break-all leading-relaxed">
                    {createdKey}
                  </p>
                </div>
          ...
          <Card>
            ...
            <div className="p-6 border-b border-border flex items-center justify-between">
              ...
              <div className="flex flex-row gap-3 items-center">
                ...
                <Button variant="outline" size="icon" onClick={() => setIsKeyModalOpen(true)}>
                  ...
                  >
                    <div className="flex flex-row gap-4 items-center min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="font-normal text-base text-foreground truncate lowercase">
                          {k.name}
                        </p>
                    ...
                    <div className="flex flex-row gap-2 shrink-0">
                      ...
                      <Button
                        ...
                        className={cn(
                          k.is_active === 1 ? 'text-emerald-600' : 'text-muted-foreground',
                        )}
                      >
                        {k.is_active === 1 ? (
                          <Icons.toggleOn className="size-6" />
                        ) : (
                          <Icons.toggleOff className="size-6" />
                        )}
                      </Button>
                      <Button
                        variant="ghost"
          ...
          <Card>
            ...
            <div className="p-6 border-b border-border flex items-center justify-between">
              ...
              <div className="flex flex-row gap-3 items-center">
                ...
                <Button variant="outline" size="icon" onClick={() => setIsDomainModalOpen(true)}>
                  <Icons.plus className="size-5" />
                </Button>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="flex flex-row gap-2 shrink-0">
                      <Button
                        ...
                        className={cn(
                          d.is_active === 1 ? 'text-emerald-600' : 'text-muted-foreground',
                        )}
                      >
                        {d.is_active === 1 ? (
                          <Icons.toggleOn className="size-6" />
            ...
            <CardContent>
              <div className="flex flex-col gap-1">
                {targetApiUrls.map((url, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between py-2 px-2 hover:bg-muted rounded-xl transition-colors group"
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <span className="text-base font-normal text-foreground truncate">{url}</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
