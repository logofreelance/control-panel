...
//
// MIGRATION: This file now re-exports from @repo/system-core-env
// All existing imports from @repo/config will continue to work
...
export {
    ...
    type AppEnv,
    type IEnvDriver,
} from '@/lib/system-core-env';

// Additional utilities for backward compatibility
import type { Context } from 'hono';
import { getEnv } from '@/lib/system-core-env';
