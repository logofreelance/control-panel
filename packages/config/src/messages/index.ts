 ...
 * 
 * 🤖 AI INSTRUCTIONS:
 * - Import MSG from '@cp/config' for frontend toasts
 * - Import ERROR/SUCCESS from '@cp/config' for backend responses
...
// ============================================
// DATA SOURCES MODULE MESSAGES
// ============================================
export const DATA_SOURCES_MESSAGES = {
    success: {
...
// Use: MSG.dataSources.success.xxx or MSG.success.xxx
// ============================================
export const MSG = {
    ...CORE_MESSAGES,
    dataSources: DATA_SOURCES_MESSAGES,
} as const;
...
// BACKEND MESSAGES
// ============================================
export { DATA_SOURCES_BACKEND, BACKEND_ERRORS, BACKEND_MESSAGES } from './backend';
