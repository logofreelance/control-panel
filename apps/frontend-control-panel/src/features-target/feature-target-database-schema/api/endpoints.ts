...
export const API = {
  ...
  updateResource: (id: string | number, rid: string | number) => `${BASE}/${id}/resources/${rid}`,
  deleteResource: (id: string | number, rid: string | number) => `${BASE}/${id}/resources/${rid}`,

  // Relations
  relations: (id: string | number) => `${BASE}/${id}/relations`,
  addRelation: (id: string | number) => `${BASE}/${id}/relations`,
  updateRelation: (id: string | number, rid: string | number) => `${BASE}/${id}/relations/${rid}`,
  deleteRelation: (id: string | number, rid: string | number) => `${BASE}/${id}/relations/${rid}`,
