...
export const DatabaseStatsCard = ({ stats, loading }: DatabaseStatsCardProps) => {
    ...
    if (loading) return null; // Let parent handle loading or showing skeleton
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm shadow-slate-200/50 hover:shadow-md hover:shadow-slate-200/50 transition-all">
                <div className="flex justify-between items-start mb-2 sm:mb-3">
                    <p className="text-[10px] sm:text-xs font-medium text-slate-500 uppercase tracking-wider">{L.databaseStorage}</p>
                ...
                <div>
                    <p className="text-xl sm:text-2xl font-semibold tracking-tight text-slate-900">
                        {totalStorageMB} <span className="text-xs sm:text-sm font-normal text-slate-400">{L.mb}</span>
                    </p>
                    <p className="text-[10px] text-teal-600 font-medium mt-1 truncate">{stats.databaseName}</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm shadow-slate-200/50 hover:shadow-md hover:shadow-slate-200/50 transition-all">
                <div className="flex justify-between items-start mb-2 sm:mb-3">
                    <p className="text-[10px] sm:text-xs font-medium text-slate-500 uppercase tracking-wider">{L.data}</p>
                ...
                <div>
                    <p className="text-xl sm:text-2xl font-semibold tracking-tight text-slate-900">
                        {totals?.dataMB.toFixed(2)} <span className="text-xs sm:text-sm font-normal text-slate-400">{L.mb}</span>
                    </p>
                    <p className="text-[10px] text-slate-400 mt-1">Raw Data</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm shadow-slate-200/50 hover:shadow-md hover:shadow-slate-200/50 transition-all">
                <div className="flex justify-between items-start mb-2 sm:mb-3">
                    <p className="text-[10px] sm:text-xs font-medium text-slate-500 uppercase tracking-wider">{L.index}</p>
                ...
                <div>
                    <p className="text-xl sm:text-2xl font-semibold tracking-tight text-slate-900">
                        {totals?.indexMB.toFixed(2)} <span className="text-xs sm:text-sm font-normal text-slate-400">{L.mb}</span>
                    </p>
                    <p className="text-[10px] text-slate-400 mt-1">Indexes</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm shadow-slate-200/50 hover:shadow-md hover:shadow-slate-200/50 transition-all">
                <div className="flex justify-between items-start mb-2 sm:mb-3">
                    <p className="text-[10px] sm:text-xs font-medium text-slate-500 uppercase tracking-wider">{L.totalRows}</p>
