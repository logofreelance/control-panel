/**
 * @repo/config/messages/backend.ts
 * 
...
// ============================================
// DATABASE SCHEMA MODULE - Backend Errors
// ============================================
export const DATABASE_SCHEMA_BACKEND = {
    error: {
        // System
        ...
        // CRUD
        notFound: 'Database schema not found',
        ...
        invalidDataSourceId: 'Invalid database schema ID',
        ...
        sourceNotFound: 'Source database schema not found',
        targetNotFound: 'Target database schema not found',
        relationExists: 'Relation between these tables already exists',
        ...
        // Generic
        createFailed: (detail: string) => `Failed to create database schema: ${detail}`,
        operationFailed: (op: string, detail: string) => `${op} failed: ${detail}`,
        cannotDestroyActive: 'Cannot destroy active database schema. Archive it first.',
    },
    ...
    success: {
        // CRUD
        created: 'Database schema created successfully',
        updated: 'Database schema updated',
        archived: 'Database schema archived',
        restored: 'Database schema restored',
        destroyed: 'Database schema and table permanently deleted',
