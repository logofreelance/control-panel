...
import { Icons, type LucideIcon } from '@/lib/config/client';
    ...
    return createPortal(
        <div className="fixed inset-0 z-9999! flex items-center justify-center p-4">
            <div
                ...
                onClick={onClose}
            ></div>
            <div className="bg-white w-full max-w-sm rounded-3xl p-8 shadow-2xl animate-in zoom-in-95 duration-300 relative z-10000!">
                <div className="flex flex-col items-center text-center gap-0">
                    <div className={`w-12 h-12 rounded-2xl ${style.iconBg} flex items-center justify-center mb-5 shadow-sm`}>
                    ...
                    <div className="flex gap-3 w-full">
                        ...
                        <button
                            ...
                            onClick={onConfirm}
                            disabled={loading}
                            className={`flex-1 px-4 py-2 rounded-xl text-white transition-all ${style.bg} ${style.hoverBg} disabled:opacity-50 flex items-center justify-center gap-2`}
                        >
                            {loading ? (
