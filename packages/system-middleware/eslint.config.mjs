    ...
    ...tseslint.configs.recommended,
    {
        ...
        settings: {
            ...
            "boundaries/elements": [
                ...
                {
                    type: "services", // Keeping general structure even if unused initially
                    pattern: "src/services/*"
                },
                {
                    type: "middleware", // Specific to system-middleware
                    pattern: "src/*.ts" // Root files in src are mostly middleware
                }
            ]
        },
        rules: {
